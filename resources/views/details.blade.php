        ...
        <div class="col-md-12">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    ...
                    @else
                    <img src="https://placehold.co/990x1024?text= No Image" alt="" class="card-img-top"></a>
                    @endif
                </div>
                <div class="col-md-8">
                    ...
                    <div class="star-rating d-inline-flex ml-2" title="">
                        <span class="rating-text theme-font theme-yellow">{{ number_format($avgRating, 2) }}</span>
                        <div class="star-rating d-inline-flex mx-2" title="">
                            <div class="back-stars ">
                                ...
                                <div class="front-stars" style="width: {{ $avgRaringPercents }}%">
                                    <i class="fa fa-star" aria-hidden="true"></i>
                                    <i class="fa fa-star" aria-hidden="true"></i>
                                    <i class="fa fa-star" aria-hidden="true"></i>
                                    <i class="fa fa-star" aria-hidden="true"></i>
                        ...
                        <div class="col-md-4 col-lg-4 mb-4">
                            <div class="card border-0 shadow-lg">
                                <a href="{{route('book.details',$relatedBook->id)}}">
                                    ...
                                    <img src="{{asset('uploads/books/thumb/'.$relatedBook->image )}}" alt="" class="card-img-top"></a>
                                @else
                                <img src="https://placehold.co/990x1024?text= No Image" alt="" class="card-img-top"></a>
                                @endif
                                </a>
